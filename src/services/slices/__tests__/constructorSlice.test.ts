...
describe('Тест слайса конструктора', () => {
  test('Добавление булки в конструктор', () => {
    ...
    const newState = constructorSlice(initialState, addIngredient(ingredients.bun))
  ...
  test('Добавление ингридиента в конструктор', () => {
    ...
    const newState = constructorSlice(initialState, addIngredient(ingredients.ingredients[0]))
  ...
  test('Перемещение ингридиентов', () => {
    ...
    const newState = constructorSlice(initialState, moveIngredient({from: 0, to: 1}))
